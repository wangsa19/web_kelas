...
@section('content')
    ...
    <section id="hero">
        <div class="max-w-full flex flex-wrap mt-20 md:mt-20 lg:mt-24 px-4 sm:px-8 md:px-12 lg:px-16 xl:px-20 bg-white gap-y-4 sm:gap-y-4 md:gap-y-6 lg:gap-y-0 lg:gap-x-4 xl:gap-x-12">
        ...
        <div class="w-full lg:mt-12 sm:mt-4 md:mt-6 flex justify-center">
        ...
        <div class="w-full sm:mt-2 md:mt-4 lg:mt-8">
            <div class="flex justify-center">
                <p class="text-center">Ragil Ridho Saputra</p>
            </div>
            <div class="flex justify-center">
                <p class="text-center mt-4">Komisi Tingkat D3 Teknik Informatika A 2023</p>
            </div>
        </div>
    </section>
